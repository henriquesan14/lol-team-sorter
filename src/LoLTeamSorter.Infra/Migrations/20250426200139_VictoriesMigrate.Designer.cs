...
namespace LoLTeamSorter.Infra.Migrations
{
    ...
    [Migration("20250426200139_VictoriesMigrate")]
    partial class VictoriesMigrate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LoLTeamSorter.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LoLTeamSorter.Domain.Entities.Matchmaking", b =>
                {
                    ...
                    b.HasOne("LoLTeamSorter.Domain.Entities.Team", "WinningTeam")
                        .WithMany()
            ...
            modelBuilder.Entity("LoLTeamSorter.Domain.Entities.RefreshToken", b =>
                {
                    b.HasOne("LoLTeamSorter.Domain.Entities.User", "User")
